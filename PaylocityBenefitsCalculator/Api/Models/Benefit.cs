...
public class Benefit: IBenefit {
    ...
    public Benefit(decimal baseCost = 1000, decimal additionalPartnerCost =  1000, decimal dependentCost = 600, int salarySurcharge = 2, decimal olderDepsSurcharge = 200) {
        BaseCost = baseCost;
